    ...
    <div>
      ...
      >
        ...
        <button
          ...
          className="absolute top-20 lg:hidden drop-shadow-md left-6 z-30 inline-flex items-center p-2 text-sm text-gray-500 rounded-lg"
        >
          <svg
            className="w-6 h-6"
            aria-hidden="true"
            ...
            <div className="h-96 xl:px-3 py-6 xl:pl-5 overflow-y-auto">
              <ul className="xl:space-y-12 lg:space-y-6 space-y-4 mt-16 ml-3 lg:text-base font-medium xl:text-xl">
                <li>
                  <Link
                    to="/"
                    className={`flex items-center p-2 lg:pl-4 text-sky-700 xl:rounded-lg hover:bg-sky-500 `}
                  >
                    <svg
