      ...
      <div className="mx-auto sm:px-6 lg:px-10">
        <div className="relative flex h-16 items-center justify-between">
          ...
          <div className="absolute inset-y-0 right-0 flex items-center pr-2 sm:static sm:inset-auto sm:ml-6 sm:pr-0">
            {/* Existing code for notifications button */}
            ...
            <div className="relative ml-3">
              ...
              <div>
                <button
                  type="button"
                  className="relative flex rounded-full bg-sky-300 text-sm focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-100"
                  id="user-menu-button"
                  aria-expanded="false"
                  aria-haspopup="true"
                >
