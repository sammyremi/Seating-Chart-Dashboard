  ...
  return (
    <div>
      ...
      >
        ...
        <button onClick={() => setShowSidebar(!showSidebar)} class="absolute top-20 lg:hidden drop-shadow-md left-6 z-30 inline-flex items-center p-2 text-sm text-gray-500 rounded-lg">
