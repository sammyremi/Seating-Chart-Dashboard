  ...
  return (
    <div>
      ...
      >
        ...
        <button onClick={() => setShowSidebar(!showSidebar)} className="absolute top-20 lg:hidden drop-shadow-md left-6 z-30 inline-flex items-center p-2 text-sm text-gray-500 rounded-lg">
            <svg className="w-6 h-6" aria-hidden="true" fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg">
               <path clip-rule="evenodd" fill-rule="evenodd" d="M2 4.75A.75.75 0 012.75 4h14.5a.75.75 0 010 1.5H2.75A.75.75 0 012 4.75zm0 10.5a.75.75 0 01.75-.75h7.5a.75.75 0 010 1.5h-7.5a.75.75 0 01-.75-.75zM2 10a.75.75 0 01.75-.75h14.5a.75.75 0 010 1.5H2.75A.75.75 0 012 10z"></path>
            </svg>
         </button>
         {showSidebar ? <div className="absolute top-12 left-0 mt-4 mr-4 bg-red-300 rounded w-[230px] h-[70vh] z-30 overflow-auto flex flex-col">
        ...
        <div className="lg:basis-5/6 min-h-screen pt-20 px-4 z-0">
          <Outlet />
        </div>
      </div>
    </div>
