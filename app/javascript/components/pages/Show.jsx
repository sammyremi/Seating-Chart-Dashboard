    ...
    <div>
      <div style={{ textAlign: 'center', fontSize: '24px', color: "#006F99", paddingBottom: "20px" }}>
        ...
        <div className="mt-10 mb-2 flex items-center justify-center">
          ...
          ) : data.status === "Occupied" || data.status === "occupied" || data.status === "OCCUPIED" ? (
      ...
      <form>
        <div>
          <label
            for="desk_id"
            class="block text-sm font-medium text-sky-400 dark:text-white"
          >
          </label>
          <input
            type="string"
            ...
            class="mb-5 bg-gray-50 border border-sky-300 text-gray-500 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-1/3 p-2.5 mx-auto focus:outline-none"
            required
          />
        </div>
        <div>
          ...
          <select
            ...
            class="mb-5 bg-gray-50 border border-sky-300 text-gray-500 text-sm rounded-lg focus:ring-sky-500 focus:border-sky-500 block w-1/3 p-2.5 mx-auto focus:outline-none "
          >
        ...
        <button
          ...
          onClick={handleSubmit}
            class="text-white bg-sky-300 hover:bg-sky-400 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5"
          >
            Update
      </button>
        </div>
