    ...
    <div>
      ...
      <div className="mt-10 mb-2 flex items-center justify-center">
        {data.status.toLowerCase() === "vacant" ? (
          <svg
            fill="currentColor"
            className="flex-shrink-0 w-32 h-40 text-green-600 transition duration-75"
            aria-hidden="true"
          ...
          <svg
            fill="currentColor"
            className={`flex-shrink-0 w-32 h-40 transition duration-75 
          ${
            data.status.toLowerCase() === "occupied"
              ? "text-[#FFA500]"
              : data.status.toLowerCase() === "damaged"
              ? "text-red-600"
              : data.status.toLowerCase() === "reserved (it)"
              ? "text-blue-600"
