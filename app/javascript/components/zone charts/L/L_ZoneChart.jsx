...
const L_ZoneChart = () => {
  return (
    <div>
      <div class="ZoneL p-2.5 grid grid-cols-8 grid-rows-8 gap-2.5 text-center">
        ...
        <div class="occupied2 bg-cyan-300 col-start-8 col-end-9 row-start-1 row-end-9">
          occupied2
        </div>
        ...
        <div class="restroom bg-lime-500 col-start-6 col-end-8 row-start-1 row-end-2">
          restroom
        </div>
