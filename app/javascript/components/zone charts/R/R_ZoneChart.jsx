...
const R_ZoneChart = ({ data }) => {
  return (
    <div>
      <div class="ZoneR border-2 m-2 border-slate-400 rounded p-2 w-[600px] mx-auto my-2 grid grid-cols-14 grid-rows-12 gap-y-4 gap-x-2 text-center">
        {/* Desk_id: #49-51 */}
        ...
        {/* Desk_id: #3-12 */}
        <div class="ocpd6  col-start-8 col-end-13  row-start-8 row-end-10 flex flex-col place-content-center">
          {/* occupied6 */}
          <div className="flex flex-row -scale-y-100 justify-end">
        ...
        {/* Desk_id: #52-55 */}
        <div class="ocpd7  col-start-1 col-end-5 row-start-10 row-end-11 flex -scale-y-100">
          {/* occupied7 */}
        ...
        {/* Desk_id: #1-2 */}
        <div class="ocpd8 bg-red-300 mt-10 col-start-11 col-end-13 row-start-10 row-end-11 flex -scale-y-100 justify-end">
          {/* occupied8 */}
          <Desk data={data[0]} style="-scale-x-100" />
          <Desk data={data[1]} style="-scale-x-100" />
        </div>
        {/* Desk_id: #7-8 */}
        <div class="ocpd9 col-start-6 col-end-8 row-start-10 row-end-12 flex flex-col place-content-center">
          {/* occupied9 */}
