...
const R_ZoneChart = ({ data }) => {
  return (
    <div>
      <div class="ZoneR p-2.5 grid grid-cols-14 grid-rows-13 gap-2.5 text-center">
        ...
        <div class="ocpd1 bg-cyan-300 col-start-10 col-end-13 row-start-1 row-end-2 flex justify-end">
          {/* occupied1 */}
          <Desk data={data[50]} />
          <Desk data={data[49]} />
          <Desk data={data[48]} />
        </div>
        <div class="ocpd2 bg-cyan-300 col-start-1 col-end-7 row-start-3 row-end-5 flex flex-col place-content-center">
          {/* occupied2 */}
        ...
        <div class="ocpd3 bg-cyan-300 col-start-8 col-end-13 row-start-3 row-end-5 flex flex-col place-content-center">
          {/* occupied3 */}
        ...
        <div class="ocpd4 bg-cyan-300 col-start-8 col-end-13  row-start-6 row-end-8 flex flex-col place-content-center">
          {/* occupied4 */}
          <div className="flex flex-row -scale-y-100 justify-end">
        ...
        <div class="ocpd5 bg-cyan-300 col-start-1 col-end-7 row-start-6 row-end-8 flex flex-col place-content-center">
          {/* occupied5 */}
          <div className="flex flex-row -scale-y-100">
        ...
        <div class="ocpd6 bg-cyan-300 col-start-8 col-end-13  row-start-9 row-end-11 flex flex-col place-content-center">
          {/* occupied6 */}
          <div className="flex flex-row -scale-y-100 justify-end">
        ...
        <div class="ocpd7 bg-cyan-300 col-start-1 col-end-5 row-start-11 row-end-12 flex -scale-y-100">
          {/* occupied7 */}
        ...
        <div class="ocpd8 bg-cyan-300 col-start-11 col-end-13 row-start-12 row-end-13 flex -scale-y-100 justify-end">
          {/* occupied8 */}
          <Desk data={data[0]} style="-scale-x-100" />
          <Desk data={data[1]} style="-scale-x-100" />
        </div>
        <div class="ocpd9 bg-cyan-300 col-start-7 col-end-8 row-start-9 row-end-11 flex flex-col place-content-center">
          {/* occupied9 */}
          <div className="flex flex-row -scale-y-100 justify-center">
        ...
        <div class="zonej grid place-items-center bg-orange-100 col-start-13 col-end-15 row-start-1 row-end-14">
          {/* Zone J */}
        ...
        <div class="Door grid place-items-center bg-pink-300 col-start-8 col-end-9 row-start-13 row-end-14">
          {/* door */}
          <svg
