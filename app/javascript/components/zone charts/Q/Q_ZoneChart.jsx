...
import "./ZoneQstyle.css";

const Q_ZoneChart = () => {
  return (
    <div>
      <div id="content" class="ZoneQ">
        <div class="restroom1">restroom1</div>
        <div class="occupied1">occupied1</div>
        <div class="restroom2">restroom2</div>
        ...
        <div class="occupied12">occupied12</div>
        <div class="zoner">Zone R</div>
