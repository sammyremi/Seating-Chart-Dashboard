...
const J_ZoneChart = ({ data }) => {
  return (
    <div className="border-2 m-2 border-slate-400 rounded w-[360px] my-2 mx-auto">
      <div className="ZoneJ p-2.5 grid grid-cols-4 grid-rows-8 gap-2.5">
        <div className="zoneR grid rounded-sm place-items-center bg-[#e9f9fd] col-start-1 col-end-2 row-start-1 row-end-9">
          <div>
            <p>Zone R</p>
            <svg
              fill="#000000"
        ...
        <div className="ocp1 col-start-3 col-end-4 row-start-1 row-end-2 flex flex-row items-center">
          <Desk data={data[14]} />
          <Desk data={data[15]} />
          <Desk data={data[16]} />
          <Desk data={data[17]} />
        ...
        <div className="ocp2 col-start-3 col-end-4 row-start-3 row-end-5 flex flex-col">
        ...
        <div className="ocp3 col-start-3 col-end-4 row-start-6 row-end-8 flex flex-col">
          <div className="flex flex-row -scale-y-100">
        ...
        <div className="Door flex self-end mb-[-6px] justify-self-center col-start-2 col-end-3 row-start-8 row-end-9">
          <svg
            className="w-7 h-7 text-slate-500"
            fill="#000000"
            viewBox="0 0 32 32"
