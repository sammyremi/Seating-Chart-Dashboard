...
const Sidenav = () => {
  return (
    <aside
      id="default-sidebar"
      class="z-40 w-full h-screen transition-transform -translate-x-full sm:translate-x-0"
      aria-label="Sidebar"
    >
      <div class="h-full px-3 py-6 pl-7 overflow-y-auto bg-gray-50 dark:bg-gray-800">
        <ul class="space-y-6 font-medium text-lg">
          <li>
            <Link
              to="/"
              class="flex items-center p-2 text-sky-700 rounded-lg dark:text-white hover:bg-sky-100 dark:hover:bg-gray-700 group"
            >
              <svg
                class="w-7 h-7 text-sky-700 transition duration-75 dark:text-gray-400 group-hover:text-sky-700 dark:group-hover:text-white"
                fill="currentColor"
                aria-hidden="true"
                viewBox="0 0 24 24"
          ...
          <li>
            ...
            >
              <svg
                class="flex-shrink-0 w-7 h-7 text-sky-700 transition duration-75 dark:text-gray-400 group-hover:text-sky-700 dark:group-hover:text-white"
                fill="currentColor"
                aria-hidden="true"
                viewBox="0 0 512 512"
                xmlns="http://www.w3.org/2000/svg"
    		...
    		C512,362.444,463.765,330.798,388.88,313.04z"
              ...
              <span class="flex-1 ml-3 whitespace-nowrap">Floor Map</span>
            </Link>
          </li>
          <li>
            <Link
            ...
            >
              ...
              <span class="flex-1 ml-3 whitespace-nowrap">Zones</span>
            </Link>
          </li>
          <li>
            <Link
...

{
  /* <aside
  id="default-sidebar"
  className="z-40 w-full h-screen transition-transform -translate-x-full"
  aria-label="Sidebar"
>
  <div className="h-full px-3 py-4 pl-7 overflow-y-auto">
    <ul className="space-y-2 font-medium text-5xl">
      <li>
        <Link className="flex items-center p-2 text-sky-700 rounded-lg hover:bg-sky-100 ">
          <svg
            fill="currentColor"
            className="flex-shrink-0 w-7 h-7 text-sky-700 transition duration-75   "
            aria-hidden="true"
            viewBox="0 0 24 24"
            xmlns="http://www.w3.org/2000/svg"
          >
