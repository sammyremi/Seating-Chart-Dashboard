...
class ZonesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create zone" do
    assert_difference("Zone.count") do
      post zones_url, params: { zone: { campaign: @zone.campaign, desk_id: @zone.desk_id, status: @zone.status } }
    end
  ...
  test "should update zone" do
    patch zone_url(@zone), params: { zone: { campaign: @zone.campaign, desk_id: @zone.desk_id, status: @zone.status } }
